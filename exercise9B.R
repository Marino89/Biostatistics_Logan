...
###################################################
paruelo <- read.table('Chapter9/Data/paruelo.csv', header=T, sep=',')
...
###################################################
library(car)
scatterplotMatrix(~C3+MAP+MAT+JJAMAP+DJFMAP+LONG+LAT, data=paruelo, diag="boxplot")


###################################################
### chunk number 3: pg 231
###################################################
scatterplotMatrix(~log10(C3+0.1)+MAP+MAT+JJAMAP+DJFMAP+LONG+LAT, data=paruelo, diag="boxplot")
